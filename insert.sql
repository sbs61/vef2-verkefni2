...
INSERT INTO applications(name, email, simi, texti, starf, unnin) VALUES (
    ...
    Phasellus tincidunt ante nisl, eu placerat arcu porttitor mollis. 
    Duis porttitor dolor vitae aliquet sollicitudin. Etiam scelerisque, 
    lorem eu varius eleifend, elit diam facilisis leo, sit amet volutpat 
    est enim eu tortor. Mauris non tortor eget nibh fermentum maximus vel 
    sit amet ante. Vestibulum condimentum facilisis nisl eget interdum. 
...
INSERT INTO applications(name, email, simi, texti, starf, unnin) VALUES (
    ...
    tortor ante ultrices orci, nec placerat dui purus ac augue. 
    Nullam aliquet purus sit amet erat laoreet, nec consequat augue 
    suscipit. Curabitur rutrum pretium erat sed pellentesque. 
    Proin ligula massa, varius id tristique in, varius id elit. 
...
INSERT INTO applications(name, email, simi, texti, starf, unnin) VALUES (
    ...
    Quisque porta quam ac orci dignissim convallis. Nunc efficitur 
    sagittis felis at gravida. Praesent quis quam molestie, rutrum mi 
    sed, malesuada nisi. Lorem ipsum dolor sit amet, 
    consectetur adipiscing elit. Suspendisse felis tortor, 
    imperdiet in metus eget, bibendum aliquet nisl.',
    'verkefnastjóri', false);
